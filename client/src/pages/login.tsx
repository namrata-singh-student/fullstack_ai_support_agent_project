...
export default function Login() {
  ...
  const enableDevLogin = import.meta.env.VITE_E2E_TEST_MODE === "true";
  ...
  async function onDevLogin() {
    await apiPost("/auth/e2e/login", {
      id: "e2e_user_1",
      email: "e2e@test.local",
      name: "E2E User",
    });

    // Full reload so AuthProvider re-fetches /auth/me with the new cookie.
